...
export default function TermsAndConditions() {
  ...
  // Process the termsAndConditions content
  const termsContent = portalData[0]?.termsAndConditions || ''
  ...
  return (
    <StyledContainer maxWidth="md">
      <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
        {/* <StyledBackButton onClick={handleBack} aria-label="Back to Careers">
          <ArrowBackIcon />
        </StyledBackButton> */}
        <Typography
          variant="h1"
