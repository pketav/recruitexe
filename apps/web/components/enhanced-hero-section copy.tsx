        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              <div className="relative z-10 bg-gradient-to-br from-white/20 to-white/5 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20">
                {/* Dashboard Preview */}
                <div className="relative rounded-2xl overflow-hidden">
                  ...
                  <div className="p-6">
                    <img
                      src="/re001.png"
                      alt="AI-Powered Recruitment Dashboard showing candidate screening interface"
