...
const JoditProEditor = ({
  ...
  const getVariables = async type => {
    ...
    try {
      const res = await axios.get(`${baseUrl}/v1/api/mail/content/getEmailPlaceholders?modelName=${type}`, {
        headers: {
  ...
  const getAllSenders = async () => {
    try {
        const res = await axios.get(`${baseUrl}/v1/api/mail/content/senderMail`, {
          headers: {
            'Content-Type': 'application/json',
            authorization: token
          }
...
console.log("res",res)
  ...
  const generateFullHTML = () => `<div>${content}</div>`;
              ...
              <Box mb={3}>
                ...
                <Grid container spacing={3}>
                  ...
                  <CustomTextField
                        ...
                        required
                        >
                        <MenuItem value="Employee Login">Employee Login</MenuItem>
                        <MenuItem value="Candidate Apply">Candidate Apply</MenuItem>
                        <MenuItem value="Resume Selection">Resume Selection</MenuItem>
                        <MenuItem value="Candidate Document Request Mail">Candidate Document Request Mail</MenuItem>
                        </CustomTextField>
                  </Grid>
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    <Autocomplete
                      ...
                      options={[
                        ...
                        { key: 'candidateInterview', label: 'Candidate Interview'}
                      ]}
                      value={{
                        key: variablesType,
                        label:
                          variablesType === 'jobPost'
                            ...
                            : variablesType === 'jobApply'
                              ...
                              : variablesType === 'jobPostAndApply'
                                ...
                                : variablesType === 'candidateInterview'
                                  ? 'Candidate Interview' 
                                    : ''
